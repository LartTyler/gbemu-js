...
export const ShiftRightLogicalOperators: OperatorInterface[] = [
	// region Registers
	new Operator('ShiftARightLogical', 0x3F, hardware => shiftRegister('a', hardware)),
	new Operator('ShiftBRightLogical', 0x38, hardware => shiftRegister('b', hardware)),
	new Operator('ShiftCRightLogical', 0x39, hardware => shiftRegister('c', hardware)),
	new Operator('ShiftDRightLogical', 0x3A, hardware => shiftRegister('d', hardware)),
	new Operator('ShiftERightLogical', 0x3B, hardware => shiftRegister('e', hardware)),
	new Operator('ShiftHRightLogical', 0x3C, hardware => shiftRegister('h', hardware)),
	new Operator('ShiftLRightLogical', 0x3D, hardware => shiftRegister('l', hardware)),
	// endregion
